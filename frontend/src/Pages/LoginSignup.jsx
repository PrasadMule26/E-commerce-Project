  ...
  return (
    <div className="loginsignup">
      ...
      <div className='loginsignup_fields'>
        ...
        <input name='email' value={formData.email} onChange={changeHandler}  type="emailId" placeholder='Email Address' />
        <input name='password' value={formData.password} onChange={changeHandler} type="password" placeholder='Password' />
      </div>
        <button onClick={()=>{state==="Login"?login():signup()}} >Continue</button>
        {state==="Sign Up"?<p className='loginsignup_login'>Already have an account? <span onClick={()=>{setState("Login")}}>Login here</span></p>
